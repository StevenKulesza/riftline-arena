...
const THIRD_PERSON_CAMERA_PORTRAIT_DISTANCE_SCALE = 1.55;
const THIRD_PERSON_CAMERA_PORTRAIT_DISTANCE_MAX = 0.9;
const THIRD_PERSON_CAMERA_SHOULDER_MIN = 0.3;
const THIRD_PERSON_CAMERA_SHOULDER_MAX = 1.05;
const THIRD_PERSON_CAMERA_SHOULDER_ASPECT_SCALE = 0.6;
const THIRD_PERSON_CAMERA_HEIGHT = 1.32;
